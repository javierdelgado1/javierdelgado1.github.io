<template>
  ...
  <section id="latest-posts" class="bg-white">
    <div class="section-content">
      <h3 class="text-muted" v-html="$t('menu.lastestPost')"></h3>
      <div class="masonry row">
        <div class="masonry-sizer col-sm-6 col-xs-12"></div>
        <div class="masonry-item col-sm-6 col-xs-12">
          <article class="post item">
            <div class="post-image"><img src="https://javierdelgado.com.ve/apps/portfolio/src/assets/img/posts/post01.jpg" alt=""></div>
        ...
        <div class="masonry-item col-sm-6 col-xs-12">
          <article class="post item">
            <div class="post-image"><img src="https://javierdelgado.com.ve/apps/portfolio/src/assets/img/posts/post02.jpg" alt=""></div>
            <div class="post-content">
              <ul class="post-meta">
                <li><i class="ti-time"></i><span>25 Sep 2015</span></li>
                <li><i class="ti-tag"></i><span><a href="#">Webdesign</a></span></li>
        ...
        <div class="masonry-item col-sm-6 col-xs-12">
          <article class="post item">
            <div class="post-image"><img src="https://javierdelgado.com.ve/apps/portfolio/src/assets/img/posts/post03.jpg" alt=""></div>
            <div class="post-content">
              <ul class="post-meta">
                <li><i class="ti-time"></i><span>25 Sep 2015</span></li>
                <li><i class="ti-tag"></i><span><a href="#">Webdesign</a></span></li>
